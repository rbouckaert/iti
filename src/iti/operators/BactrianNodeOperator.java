...
public class BactrianNodeOperator extends TreeOperator {
    ...
    final public Input<NodeSet> nodeSetInput = new Input<>("nodeset", "set of nodes to operator on, or all nodes if not specified"); 
    ...
    public double proposal() {
        ...
        Node node;
        if (nodeSet != null) {
        	int [] nodeNumbers = nodeSet.getNodeNumbers();
        	node = tree.getNode(nodeNumbers[Randomizer.nextInt(nodeNumbers.length)]);
        } else {
	        do {
